...
int main()
{
	...
	Shader prefilterShader("cubemap.vs", "prefilter_environment.fs");
	...
	//left part:prefilter environment map
...
// renderQuad() renders a 1x1 XY quad in NDC(Normalized Device Coordinates)
// -----------------------------------------
